...
| --- | --- | --- | --- |
| Marketing emails/newsletters for campaigns | Jordan | Weekly sends per campaign | Campaign emails drafted and shipped. |
| Landing pages and funnels for offers and challenge | Jordan | Ongoing with launch reviews | High-converting pages live with post-launch reviews. |
| Sales video scripts/VSLs and advertising assets (copy, graphics, thumbnails) | Jordan | Per campaign | Creative assets produced for each campaign. |
