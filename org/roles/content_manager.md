...
### Titles & Descriptions
- [ ] Write high-CTR titles for each YouTube video (8 per month)
- [ ] Write SEO-optimised descriptions with relevant links
...
- [ ] Configure end cards and mid-roll cards on videos
- [ ] Schedule videos for optimal posting times
- [ ] Ensure all metadata and settings are correct before publish

### Performance Tracking
- [ ] Track video performance (views, CTR, retention, engagement)
- [ ] Report weekly performance insights to team
- [ ] Identify patterns and make recommendations for improvement
- [ ] Maintain performance dashboard or tracker

### Asset Management
- [ ] Maintain content asset tracker (script → raw → edit → publish URL)
- [ ] Ensure all published videos are logged with links
- [ ] Archive and organise historical content data
...
- **Asset tracker:** Current and accurate at all times
